...
const customBubble = (props) => (
    <div>
        <p>{`${props.message.senderName} ${props.message.id ? "says" : "said"}: ${props.message.message
            }`}</p>
    </div>
);
...
class Chat extends React.Component {
    constructor() {
        ...
        this.state = {
            messages: [
                new Message({ id: "Jamshid", message: "Hey guys!", senderName: "Jamshid" }),
                new Message({
                    id: 2,
                    message: (
                        <p>
                ...
                <div className="chatfeed-wrapper">
                    ...
                    <div style={{ display: "flex", justifyContent: "space-around" }}>
                        ...
                        <button
                            style={{
                                ...styles.button,
                                ...(this.state.curr_user === "Jamshid" ? styles.selected : {})
                            }}
                            onClick={() => this.onPress("Jamshid")}
                        >
                            Jamshid
                        </button>
                        <button
